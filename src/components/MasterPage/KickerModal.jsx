...
const KickerModal = ({ fetchKicker, onClose, modalData }) => {
  ...
  const updateKicker = async () => {
    ...
    axios
      .post("https://aarnainfra.com/ladder/updateKicker.php", {
      ...
      <div className="modal mx-auto max-h-[80vh] w-[560px] overflow-y-scroll rounded-xl bg-white pb-4   pl-6 pr-6 outline-none">
        ...
        <div className="px-4 mt-5  pb-5">
          ...
          <div className="flex items-center gap-6 justify-center mt-6">
            ...
            <a
              target="_blank"
              href={`https://aarnainfra.com/ladder/download.php?file_type=fresh&unique_id=${modalData?.kicker_id}`}
            ...
            {modalData?.extended_date !== null && (
              <a
                href={`https://aarnainfra.com/ladder/download.php?file_type=extended&unique_id=${modalData?.kicker_id}`}
                className="bg-[#9A55FF] text-white rounded text-xs font-semibold  py-2 px-4"
              >
                View Ext. Creative
              </a>
